...
- Крок 1 (каталог) — 16 позицій, три критеріальні тести проходять.
...
- Далі: дім (`household` як головна одиниця, спільна комора vs особистий профіль, вартість промпту на кількох учасників), мережа.
