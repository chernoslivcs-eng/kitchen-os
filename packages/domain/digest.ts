...
/** Серверна команда: анекдот про стан дому. Текст — дослівно від власника 17.09. */
export const DIGEST_REQUEST =
  '[СЕРВЕР] Розкажи людині анекдот про поточний стан її дому: короткий, з сюжетом і панчлайном наприкінці, три-пʼять речень, до 400 знаків, у своєму голосі. '
  + 'Персонажі — те, що є в контексті: продукти з комори (що відкрите й давно чекає, чого підозріло багато, що лежить у морозилці), те, що самотньо висить у списку покупок, події з календаря, останні готування. '
  + 'Візьми один-два факти, не перелічуй усе. Добрий гумор, без сарказму про людину, без порад, без запитань, без заголовків і маркерів, без грамів. Нічого не вигадуй про дім.';
