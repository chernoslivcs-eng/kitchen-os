...
describe('[ЗГЕНЕРОВАНІ РЕЦЕПТИ] в контексті', () => {
  // Було «жодного токена». M13-ROLE-VOICE п.1: на «а що ти там пропонував?»
  // без блока модель не мала джерела й вигадувала власні минулі рецепти.
  it('порожньо — блок є і каже, що рецептів ще не генерував', () => {
