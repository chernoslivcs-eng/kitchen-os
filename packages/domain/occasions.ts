...
function movableOccasions(date: Date, trads: Tradition[]): Occasion[] {
  ...
  if (inRange(shift(-48), shift(-1))) out.push({
    ...
    restricts: 'жодного мʼяса, риби, молочного і яєць — ні у стравах, ні в needs, ні в rescues (запропонувати «врятувати» вершки — теж запропонувати їх зʼїсти). Рослинні аналоги (кокосове молоко, тахіні) можна',
