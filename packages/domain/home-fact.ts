...
//   2. Чистка відповіді моделі (Р146): 1–3 речення, разом ≤ 220 знаків, лише
//      текст; довше — зріз по межі останнього повного речення; емодзі або
//      порожнє — null (лишається шаблон).
