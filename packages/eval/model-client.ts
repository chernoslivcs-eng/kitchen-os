...
function fixtureAsUserTurn(fx: Fixture): Anthropic.MessageParam[] {
  ...
  if (fx.call === 'attachment_parse') {
    ...
    // вже немає, на семи фікстурах attachment_parse. Тест тримає їх рівними.
    parts.push({
      type: 'text',
      text: 'Розбери за схемою й поверни JSON. Користувач бачив вкладення на власні очі — його слово важливіше. JSON компактний: без відступів і переносів рядків. Це про пробіли, а не про вміст — назви лишаються повними.',
    });
