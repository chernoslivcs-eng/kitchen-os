...
### Доповнення 16.09: чек зі скріншота низької якості (receipt-lowres-silpo)

13 позицій, розпізнаний вручну текст + еталон (`receipt-lowres-silpo.ETALON.md`),
фікстура `receipt-lowres-silpo.json` з інваріантом `lowres-etalon` (13/13, шум
ШК/УКТ/ПІДСУМОК не стає позицією, ваги 892/384/160 г, бренди Lay's/Селянське/
АХА/King Oscar, сидр alcohol:true, свинина cooked/ready, пакети — окремою
позицією). Прогони: без параметра і minimal=256.

| виклик | рівень | зелених | latency | токени | JSON |
|---|---|---|---|---|---|
| lowres-чек (13 позицій) | без параметра | 1/1 (4/4 інв.) | 13,8 с | out 3255 · роздуми 2238 | 1/1 |
| lowres-чек | minimal=256 | 1/1 (4/4 інв.) | 3,8 с | out 1032 · роздуми 0 | 1/1 |

Обидва: 13/13, ваги 892/384/160 г, бренди Lay's/Селянське/АХА/King Oscar,
сидр alcohol:true, пакети біорозкладні окремою позицією (не в комору — відсікає
каталог). Дві правки еталона за виходом моделі: «Печ121KingOscTрісКон» — це
**печінка тріски консервована** (King Oscar), не печиво (ручний еталон
помилявся, обидва прогони дали правильне); свинина запечена — cooked або ready
(готова до столу) — обидва чесні за словником промпту, у трьох прогонах були
обидва варіанти. Перші два прогони до правки еталона — 3/4 в обох, ті самі два
пункти. Вартість: 5 викликів ≈ $0.04.

```
Модель: google/gemini-3.8-flash

=== lowres (receipt-lowres-silpo) ===
--- minimal ---
  [minimal] receipt-lowres-silpo        3/4   3764ms out= 1024 think=    0 json=ok  ✗ lowres-etalon (нема печив)
         рядків 13/13, еталонних 0/0, брендів 7
           · сидр яблучний напівсухий Moloko viter | сидр | Moloko viter | яблучний напівсухий | 750 ml | {"alcohol":true,"shelf_open_days":5}
           · порічка | порічка |  |  | 250 g | {"processing":"raw"}
           · багет французький люкс | багет |  | французький люкс | 300 g | {"allergens":["глютен"],"processing":"ready"}
           · сир маасдам 45% нарізка Veldhuyzen Kaas | маасдам | Veldhuyzen Kaas | 45% нарізка | 150 g | {"allergens":["молоко"],"fasting":true,"lactose":"low","processing":"ready","shelf_open_days":21}
           · пакет біорозкладний 3 кг | пакет |  | біорозкладний 3 кг | 2 pcs | {}
           · грейпфрут | грейпфрут |  |  | 892 g | {"processing":"raw"}
           · картопляні чипси Lay's з сиром | чипси картопляні | Lay's | з сиром | 120 g | {"allergens":["молоко"],"processing":"ready"}
           · молоко ультрапастеризоване 2,5% Селянське | молоко | Селянське | ультрапастеризоване 2,5% | 500 ml | {"allergens":["молоко"],"fasting":true,"lactose":"yes","processing":"ready","shelf_open_days":5}
           · гранола з полуницею АХА | гранола | АХА | з полуницею | 330 g | {"allergens":["глютен"],"processing":"ready"}
           · соняшникова олія рафінована Щедрий Дар | олія соняшникова | Щедрий Дар | холодна рафінація | 500 ml | {"processing":"ready"}
           · томати рожеві українські | томати |  | рожеві українські | 384 g | {"processing":"raw"}
           · печінка тріски консервована King Oscar | печінка тріски | King Oscar | консервована | 121 g | {"allergens":["риба"],"fasting":true,"processing":"ready","shelf_open_days":3}
           · свинина запечена з чорносливом | свинина запечена |  | з чорносливом | 160 g | {"fasting":true,"processing":"cooked","shelf_open_days":5}

| виклик | рівень | зелених фікстур | latency медіана | токени | JSON |
|---|---|---|---|---|---|
| lowres | minimal | 0/1 | 3764 мс (p90 3764) | out Σ 1024 · роздуми Σ 0 | 1/1 |

Модель: google/gemini-3.8-flash

=== lowres (receipt-lowres-silpo) ===
--- без параметра ---
  [base] receipt-lowres-silpo        4/4  13806ms out= 3255 think= 2238 json=ok 
         рядків 13/13, еталонних 0/0, брендів 7
--- minimal ---
  [minimal] receipt-lowres-silpo        4/4   3803ms out= 1032 think=    0 json=ok 
         рядків 13/13, еталонних 0/0, брендів 5

| виклик | рівень | зелених фікстур | latency медіана | токени | JSON |
|---|---|---|---|---|---|
| lowres | без параметра | 1/1 | 13806 мс (p90 13806) | out Σ 3255 · роздуми Σ 2238 | 1/1 |
| lowres | minimal | 1/1 | 3803 мс (p90 3803) | out Σ 1032 · роздуми Σ 0 | 1/1 |
