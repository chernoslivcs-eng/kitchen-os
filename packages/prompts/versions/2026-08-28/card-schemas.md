...
{"type":"profile","field":"name|no|ban|love|meh|kit|when","mode":"append|replace","text":"продовження речення поля словами людини"}
{"type":"profile","ops":[{"op":"add|remove","kind":"tradition|note|intent|member","label":"значення","recipe":"назва страви","rating":4,"diet":"веганство","wishes":["веганство"],"antipatterns":["не їм мʼяса"],"allergies":[]}]}
