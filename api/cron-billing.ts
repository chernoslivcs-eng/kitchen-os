// Vercel Cron entrypoint для крона біллінгу (спек 2026-09-25) — тонкий
// шар над пребандленим api-dist/cron-billing.mjs (та сама причина, що
...
export default async function entry(req: IncomingMessage, res: ServerResponse) {
  if (!cached) {
    const bundlePath = join(process.cwd(), 'api-dist/cron-billing.mjs');
