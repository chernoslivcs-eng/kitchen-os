...
// нотатки, мережі, акаунт. Рендериться під PROFILE_V2 — ознака прапора для
// клієнта: GET /v1/profile віддає `fields` (ProfileRoute). Стара сторінка
// (Profile.tsx) живе без змін під вимкненим прапором.
//
