...
export interface Turn {
  ...
  // Постановка 2026-09-25 (режим без підписки): 402 paywall — кнопка під
  // бульбашкою на екран «Підписка». Ephemeral, як cartNudge: на F5 не
  // переживає (репліка людини теж не зберігалась на сервері).
  paywall?: { label: string; to: string };
}
