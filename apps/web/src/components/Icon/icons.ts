...
export const ICONS = {
  ...
  // Постановка 2026-09-25 (екран «Підписка»): маска картки в статусі —
  // credit-card, той самий глиф, що в бандлі Kitchen OS - Subscription.dc.html.
  'sys.card':      { glyph: CreditCard,        label: 'Картка',        family: 'system' },
