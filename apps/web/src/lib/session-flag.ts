// AUTH-BRIEF-0915: дефолт режиму на лендингу — «Реєстрація» для нових людей,
// «Вхід» для тих, хто вже мав тут сесію на цьому браузері. Ставимо ознаку
// при УСПІШНОМУ вході (store/auth.ts refresh() → status signed_in), тому
// перший вхід і досі бачить «Реєстрація» — саме туди він і мав потрапити.
