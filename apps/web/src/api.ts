...
export const api = {
  ...
  // Р146: «факт дому» під чіпами порожньої розмови — жарт від моделі або null
  // (нема ключа, нема фактів, помилка, таймаут 15 с). Один запит без повторів;
  // кеш на день — у клієнта.
  homeFact: {
    get: () => req<{ text: string | null }>('/v1/home-fact'),
  },
  cookRuns: {
